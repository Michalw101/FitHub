        ...
        <div className="single-class-modal">
            <div className="single-class-content">
                ...
                <button onClick={toggleDetailsVisibility}>
                    {isDetailsVisible ? 'SEE LESS' : 'SEE MORE'}
                </button>
                {isDetailsVisible && (
                    <>
                        <br />
                        ...
                        <div className="wrapper">
                            ...
                            <a className="icon instagram" href={event.trainer.instegram_link}>
                                <span className="tooltip">{event.trainer.instegram_link}</span>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    height="1.2em"
                                    fill="currentColor"
